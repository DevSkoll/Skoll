...
export const siteMetaData = {
  ...
  authorName: 'Bryce Fountain',
  siteName: 'Dev_Skoll',
  defaultTitle: 'Bryce Fountain | Communicator, Developer, and Creator',
  titleTemplate: 'Bryce Fountain | %s',
  description: 'Skoll Blog and Portfolio Site',
  email: 'me@skoll.dev',
  locale: 'en_US',
  twitter: {
    handle: '@handle',
